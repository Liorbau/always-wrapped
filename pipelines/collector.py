...
# Insert order, matched by build_track_row's return tuple.
TRACK_COLUMNS = [
...
def save_tracks_to_db(tracks, spotify_client=None):
    ...
    try:
        ...
        # played_at is the dedup key: re-ingesting the same window is a no-op.
        sql = dialect_for(driver).insert_ignore(
            "listening_history", TRACK_COLUMNS, conflict="played_at")
